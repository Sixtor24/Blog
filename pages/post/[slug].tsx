            ...
            <div className="max-w-3xl mx-auto mb-10">
                <article className="w-full mx-auto p-5 bg-secondaryColor/10">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="font-bodyFont text-base">
                            Blog post by{" "}
                            <span className="font-bodyFont text-base text-secondaryColor">
                                {post.author.name}
                            </span>{" "}
                    ...
                    <div className="mt-10">
                        <PortableText
                            ...
                            projectId={
                                process.env.NEXT_PUBLIC_SANITY_PROJECT_ID || "66b775gd"
                            }
                            content={post.body}
                            serializers={{
                                h1: (props: any) => (
                ...
                <hr className="max-w-lg my-5 mx-auto border[1px] border-secondaryColor" />
                {
                    submitted ? <div className="flex flex-col items-center gap-2 p-10 my-10 bg-bgColor text-white mx-auto">
                        <h1 className="text-2xl font-bold">Thanks you for submitting your comment!</h1>
                        <div>Once it has been approved, it will appear below!</div>
                    </div> : <div>
                    <div className="text-xs text-secondaryColor uppercase font-titleFont font-bold">
                    ...
                    <form
                        ...
                        {session && <button className="w-full bg-bgColor text-white text-base font-titleFont font-semibold tracking-wider uppercase py-2 rounded-sm hover:bg-secondaryColor duration-300" 
                        type="submit"
                        >
                            Submit
                        </button>}
