        ...
        <div className="flex items-center gap-8 text-lg">
          <div className="flex items-center gap-1">
            <img
              ...
              src={
                session 
                  ? session?.user!.image! : "https://w7.pngwing.com/pngs/825/857/png-transparent-computer-icons-user-profile-user-silhouette-apple-icon-image-format-user-profile-thumbnail.png"}
              alt="logo"
            />
